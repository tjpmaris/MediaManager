...
//            var actual = await controller.Create(new PictureCreateModify() { Name = "CreatePicture", Content = "Base64" });
...
//            var actual = await controller.Create(new PictureCreateModify() { Name = "GetIdPicture", Content = "Base64" });
//            Assert.IsType<CreatedResult>(actual);
//            CreatedResult result = actual as CreatedResult;
//            var item = result.Value as Picture;
...
//            await controller.Create(new PictureCreateModify() { Name = "GetAllPicture", Content = "Base64" });
//            await controller.Create(new PictureCreateModify() { Name = "GetAllPicture", Content = "Base64" });
//            await controller.Create(new PictureCreateModify() { Name = "GetAllPicture", Content = "Base64" });
...
//            var actual = await controller.Create(new PictureCreateModify() { Name = "PutPicture", Content = "Base64" });
//            Assert.IsType<CreatedResult>(actual);
//            CreatedResult result = actual as CreatedResult;
//            var item = result.Value as Picture;
...
//            var actual = await controller.Create(new PictureCreateModify() { Name = "PatchSong", Content = "Base64" });
//            Assert.IsType<CreatedResult>(actual);
//            CreatedResult result = actual as CreatedResult;
//            var item = result.Value as Picture;
...
//            var actual = await controller.Create(new PictureCreateModify() { Name = "DeletePicture", Content = "Base64" });
//            Assert.IsType<CreatedResult>(actual);
//            CreatedResult result = actual as CreatedResult;
//            var item = result.Value as Picture;
